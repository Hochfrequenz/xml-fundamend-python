...
ahb_utilts_11d = Anwendungshandbuch(
    veroeffentlichungsdatum=datetime.date(2024, 4, 2),
    autor="BDEW",
    versionsnummer="1.1d",
    anwendungsfaelle=[
        Anwendungsfall(
                    ...
                    segment_groups=[
                        ...
                        SegmentGroup(
                                ...
                                Segment(
                                    ...
                                    data_elements=[
                                        ...
                                        DataElementGroup(
                                            id="C_C517",
                                            name="Ortsangabe",
                                            data_elements=[DataElement(id="D_3225", name="Identifikator", codes=[])],
                                        ),
                                    ],
                                ),
                                Segment(
                                                ...
                                                DataElement(
                                                    ...
                                                    codes=[
                                                        Code(
                                                            ...
                                                            description="Die Berechnungsformel zur Ermittlung der Energiemenge einer Markt- oder Netzlokation ist in diesem Vorgang der UTILTS enthalten",
                                                            value="Z33",
                                                            ahb_status="X",
                                                        ),
                                                        Code(
                                                            name="Berechnungsformel muss beim Absender angefragt werden",
                                                            description="Die Berechnungsformel zur Ermittlung der Energiemenge der Markt- oder Netzlokation ist komplex und kann mit der UTILTS nicht übermittelt werden",
                                                            value="Z34",
                                                            ahb_status="X",
                                                        ),
                                                        Code(
                                                            name="Berechnungsformel besitzt keine Rechenoperation",
                                                            description="Die Berechnungsformel zur Ermittlung der Energiemenge der Markt- oder Netzlokation besitzt keine Rechenoperation, da es sich um eine 1:1 Beziehung zwischen der Markt- und Messlokation handelt.",
                                                            value="Z40",
                                                            ahb_status="X",
                                                        ),
                                                        Code(
                                                            name="Berechnungsformel nicht erforderlich",
                                                            description="Die Berechnungsformel zur Ermittlung der Energiemenge der Markt- oder Netzlokation ist nicht erforderlich, da keine Messlokation der Marktlokation (pauschale Marktlokation) zugeordnet ist.",
                                                            value="Z41",
                                                            ahb_status="X [18]",
                                                        ),
                                                    ],
                            ...
                            segment_groups=[
                                ...
                                SegmentGroup(
                                    id="8",
                                    name="Energiemenge der Markt- bzw. Netzlokation",
                                    ahb_status="Muss [3]",
                                    segments=[
                                        Segment(
                                            id="EQ",
                    ...
                    segment_groups=[
                        ...
                        SegmentGroup(
                            ...
                            segments=[
                                ...
                                Segment(
                                    id="FTX",
                                    name="Bemerkung (Feld für allgemeine Hinweise)",
                                    number="00039",
                                    ahb_status="Muss [4]",
                                    data_elements=[
                                        DataElement(
                                            ...
                                            codes=[
                                                Code(
                                                    name="Zusätzliche Informationen (für allgemeine Hinweise)",
                                                    description=None,
                                                    value="ACB",
                                                    ahb_status="X",
                                                )
                                        ...
                                        DataElementGroup(
                                            ...
                                            data_elements=[
                                                DataElement(
                                                    id="D_4440", name="Text für allgemeine Information", codes=[]
                                                ),
                                                DataElement(id="D_4440", name="Freier Text", codes=[]),
                                                DataElement(id="D_4440", name="Freier Text", codes=[]),
                                                DataElement(id="D_4440", name="Freier Text", codes=[]),
                                                DataElement(id="D_4440", name="Freier Text", codes=[]),
                                            ],
    ...
    bedingungen=[
        ...
        Bedingung(nummer="4", text="Wenn in dieser SG5 das STS+E01++A99 (Ablehnung Sonstiges) vorhanden"),
        Bedingung(
            nummer="5",
        ...
        Bedingung(
            nummer="51", text="Wenn in SG5 LOC+172 DE3225 (Meldepunkt) die ID einer Marktlokation angegeben ist."
        ),
        Bedingung(nummer="53", text="Wenn im DE3155 in demselben COM der Code EM vorhanden ist"),
        Bedingung(nummer="54", text="Wenn im DE3155 in demselben COM der Code TE / FX / AJ / AL vorhanden ist"),
        Bedingung(
            nummer="490",
        ...
        Bedingung(nummer="529", text="Hinweis: Verwendung der ID der Netzlokation"),
        Bedingung(nummer="530", text="Hinweis: Es darf nur eine Information im DE3148 übermittelt werden"),
        ...
        Bedingung(nummer="939", text="Format: Die Zeichenkette muss die Zeichen @ und . enthalten"),
        Bedingung(
            nummer="940",
            text="Format: Die Zeichenkette muss mit dem Zeichen + beginnen und danach dürfen nur noch Ziffern folgen",
        ),
        ...
        Bedingung(nummer="960", text="Format: Netzlokations-ID"),
